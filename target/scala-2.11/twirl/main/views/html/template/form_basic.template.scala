...
class form_basic extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        ...
                        <li>
   """),
format.raw("""                         <a href="grid_options.html">
                                <div>
                            ...
                            <form method="get" class="form-horizontal">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Checkboxes and radios <br/>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div><label> <input type="radio" checked="" value="option1" id="optionsRadios1" nom="optionsRadios"> Option one is this and that&mdash;be sure to
                                            include why it's great </label></div>
                                        <div><label> <input type="radio" value="option2" id="optionsRadios2" nom="optionsRadios"> Option two can be something else and selecting it will
...
format.raw(""" type="checkbox" value="" disabled="" checked=""> <i></i> Option three checked and disabled </label></div>
                                        <div class="i-checks"><label> <input type="checkbox" value="" disabled=""> <i></i> Option four disabled </label></div>
                                        <div class="i-checks"><label> <input type="radio" value="option1" nom="a"> <i></i> Option one </label></div>
                                        <div class="i-checks"><label> <input type="radio" checked="" value="option2" nom="a"> <i></i> Option two checked </label></div>
                                        <div class="i-checks"><label> <input type="radio" disabled="" checked="" value="option2"> <i></i> Option three checked and disabled </label></div>
                                        <div class="i-checks"><label> <input type="radio" disabled="" nom="a"> <i></i> Option four disabled </label></div>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Inline checkboxes</label>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Select</label>
                                    ...
                                    <div class="col-sm-10"><select class="form-control m-b" nom="account">
    ...
    <script src="js/plugins/iCheck/icheck.min.js"></script>
        <script>
            $(document).ready(function () """),format.raw/*855.43*/("""{"""),format.raw/*855.44*/("""
                """),format.raw/*856.17*/("""$('.i-checks').iCheck("""),format.raw/*856.39*/("""{"""),format.raw/*856.40*/("""
                    """),format.raw/*857.21*/("""checkboxClass: 'icheckbox_square-green',
                    radioClass: 'iradio_square-green',
                """),format.raw/*859.17*/("""}"""),format.raw/*859.18*/(""");
...
/**/
object form_basic extends form_basic_Scope0.form_basic
              /*
                  -- GENERATED --
                  DATE: Sat Feb 20 04:10:20 CET 2016
                  SOURCE: /home/yachironi/git/myproject/app/views/template/form_basic.scala.html
                  HASH: 45eedd4da2645410405a03d63d5c6c29479d57e9
                  MATRIX: 846->0|54961->54048|54991->54049|55038->54067|55089->54089|55119->54090|55170->54112|55313->54226|55343->54227|55388->54243|55418->54244
                  LINES: 32->1|888->855|888->855|889->856|889->856|889->856|890->857|892->859|892->859|893->860|893->860
                  -- GENERATED --
              */
