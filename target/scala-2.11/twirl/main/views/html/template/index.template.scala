                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class=active"><a href=""index.scala.html">Dashboard v.1</a></li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li><a href="ecommerce-orders.scala.html">Orders</a></li>
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        ...
                        <li>
                            <div class="text-center link-block">
                               ...
                               """),
format.raw("""     <i class="fa fa-envelope"></i> <strong>Read All Messages</strong>
                                </a>
                            </div>
                        </li>
                    </ul>
                                ...
                                <div class="ibox-content">
                                    <div>
                                        ...
                                        <h4>NYS report new data!
                                            <br/>
                                            <small class=m-r"><a href="graph_flot.scala.html"> Check the stock price! </a> </small>
                                        </h4>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="feed-element">
                                                    ...
                                                    <div class="media-body ">
                                                        ...
                                                        <div class="well">
                                                            ...
                                                            """),
format.raw("""Over the years, sometimes by accident, sometimes on purpose (injected humour and the like).
                                                        </div>
...
format.raw("""            </div>
    ...
    <script>
        $(document).ready(function() """),format.raw/*1308.38*/("""{"""),format.raw/*1308.39*/("""
            """),format.raw/*1309.13*/("""setTimeout(function() """),format.raw/*1309.35*/("""{"""),format.raw/*1309.36*/("""
                """),format.raw/*1310.17*/("""toastr.options = """),format.raw/*1310.34*/("""{"""),format.raw/*1310.35*/("""
                    """),format.raw/*1311.21*/("""closeButton: true,
                    progressBar: true,
                    showMethod: 'slideDown',
                    timeOut: 4000
                """),format.raw/*1315.17*/("""}"""),format.raw/*1315.18*/(""";
                toastr.success('Responsive Admin Theme', 'Welcome to INSPINIA');

            """),format.raw/*1318.13*/("""}"""),format.raw/*1318.14*/(""", 1300);
            ...
            $("#flot-dashboard-chart").length && $.plot($("#flot-dashboard-chart"), [
                data1, data2
                    ...
                    """),format.raw/*1330.21*/("""{"""),format.raw/*1330.22*/("""
                        """),format.raw/*1331.25*/("""series: """),format.raw/*1331.33*/("""{"""),format.raw/*1331.34*/("""
                            """),format.raw/*1332.29*/("""lines: """),format.raw/*1332.36*/("""{"""),format.raw/*1332.37*/("""
                                """),format.raw/*1333.33*/("""show: false,
                                fill: true
                            """),format.raw/*1335.29*/("""}"""),format.raw/*1335.30*/(""",
                            splines: """),format.raw/*1336.38*/("""{"""),format.raw/*1336.39*/("""
                                """),format.raw/*1337.33*/("""show: true,
                                tension: 0.4,
                                lineWidth: 1,
                                fill: 0.4
                            """),format.raw/*1341.29*/("""}"""),format.raw/*1341.30*/(""",
                            points: """),format.raw/*1342.37*/("""{"""),format.raw/*1342.38*/("""
                                """),format.raw/*1343.33*/("""radius: 0,
                                show: true
                            """),format.raw/*1345.29*/("""}"""),format.raw/*1345.30*/(""",
                            shadowSize: 2
                        """),format.raw/*1347.25*/("""}"""),format.raw/*1347.26*/(""",
                        grid: """),format.raw/*1348.31*/("""{"""),format.raw/*1348.32*/("""
                            """),format.raw/*1349.29*/("""hoverable: true,
                            clickable: true,
                            tickColor: "#d5d5d5",
                            borderWidth: 1,
                            color: '#d5d5d5'
                        """),format.raw/*1354.25*/("""}"""),format.raw/*1354.26*/(""",
                        colors: ["#1ab394", "#1C84C6"],
                        xaxis:"""),format.raw/*1356.31*/("""{"""),format.raw/*1356.32*/("""
                        """),format.raw/*1357.25*/("""}"""),format.raw/*1357.26*/(""",
                        yaxis: """),format.raw/*1358.32*/("""{"""),format.raw/*1358.33*/("""
                            """),format.raw/*1359.29*/("""ticks: 4
                        """),format.raw/*1360.25*/("""}"""),format.raw/*1360.26*/(""",
                        tooltip: false
                    """),format.raw/*1362.21*/("""}"""),format.raw/*1362.22*/("""
            """),format.raw/*1363.13*/(""");

            var doughnutData = [
                """),format.raw/*1366.17*/("""{"""),format.raw/*1366.18*/("""
                    """),format.raw/*1367.21*/("""value: 300,
                    color: "#a3e1d4",
                    highlight: "#1ab394",
                    label: "App"
                """),format.raw/*1371.17*/("""}"""),format.raw/*1371.18*/(""",
                """),format.raw/*1372.17*/("""{"""),format.raw/*1372.18*/("""
                    """),format.raw/*1373.21*/("""value: 50,
                    color: "#dedede",
                    highlight: "#1ab394",
                    label: "Software"
                """),format.raw/*1377.17*/("""}"""),format.raw/*1377.18*/(""",
                """),format.raw/*1378.17*/("""{"""),format.raw/*1378.18*/("""
                    """),format.raw/*1379.21*/("""value: 100,
                    color: "#A4CEE8",
                    highlight: "#1ab394",
                    label: "Laptop"
                """),format.raw/*1383.17*/("""}"""),format.raw/*1383.18*/("""
            """),format.raw/*1384.13*/("""];

            var doughnutOptions = """),format.raw/*1386.35*/("""{"""),format.raw/*1386.36*/("""
                """),format.raw/*1387.17*/("""segmentShowStroke: true,
            ...
            var polarData = [
                """),format.raw/*1401.17*/("""{"""),format.raw/*1401.18*/("""
                    """),format.raw/*1402.21*/("""value: 300,
                    color: "#a3e1d4",
                    highlight: "#1ab394",
                    label: "App"
                """),format.raw/*1406.17*/("""}"""),format.raw/*1406.18*/(""",
                """),format.raw/*1407.17*/("""{"""),format.raw/*1407.18*/("""
                    """),format.raw/*1408.21*/("""value: 140,
                    color: "#dedede",
                    highlight: "#1ab394",
                    label: "Software"
                """),format.raw/*1412.17*/("""}"""),format.raw/*1412.18*/(""",
                """),format.raw/*1413.17*/("""{"""),format.raw/*1413.18*/("""
                    """),format.raw/*1414.21*/("""value: 200,
                    color: "#A4CEE8",
                    highlight: "#1ab394",
                    label: "Laptop"
                """),format.raw/*1418.17*/("""}"""),format.raw/*1418.18*/("""
            """),format.raw/*1419.13*/("""];

            var polarOptions = """),format.raw/*1421.32*/("""{"""),format.raw/*1421.33*/("""
                """),format.raw/*1422.17*/("""scaleShowLabelBackdrop: true,
                ...
                animateRotate: true,
                animateScale: false
            """),format.raw/*1435.13*/("""}"""),format.raw/*1435.14*/(""";
