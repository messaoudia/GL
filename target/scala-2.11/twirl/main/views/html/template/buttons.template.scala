                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        ...
                        <li>
                            <a href="grid_options.html">
                                <div>
                                    <i class="f"""),
format.raw("""a fa-upload fa-fw"></i> Server Rebooted
                                    <span class="pull-right text-muted small">4 minutes ago</span>
                                </div>
                            </a>
                        </li>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="#""""),
format.raw(""">Separated link</a></li>
                            </ul>
                        </div>
                        <div class="btn-group">
...
object buttons extends buttons_Scope0.buttons
              /*
                  ...
                  SOURCE: /home/yachironi/git/myproject/app/views/template/buttons.scala.html
                  HASH: 1e978f3b0dd014ba8c802c91aad1c6a84c364a9c
                  MATRIX: 840->0
                  LINES: 32->1
                  -- GENERATED --
              */
