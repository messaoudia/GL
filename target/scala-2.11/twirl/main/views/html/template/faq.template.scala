                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        ...
                        <li>
                            <a href="grid_options.html">
                                <div>
                                    <i class="fa fa-upload fa-fw"></i> Server Reboo"""),
format.raw("""ted
                                    <span class="pull-right text-muted small">4 minutes ago</span>
                                </div>
                            </a>
...
format.raw("""l-lg-12">
    ...
    <script>
        $(document).ready(function()"""),format.raw/*725.37*/("""{"""),format.raw/*725.38*/("""

            """),format.raw/*727.13*/("""$('#loading-example-btn').click(function () """),format.raw/*727.57*/("""{"""),format.raw/*727.58*/("""
                """),format.raw/*728.17*/("""btn = $(this);
                simpleLoad(btn, true)

                // Ajax example
//                $.ajax().always(function () """),format.raw/*732.47*/("""{"""),format.raw/*732.48*/("""
"""),format.raw/*733.1*/("""//                    simpleLoad($(this), false)
//                """),format.raw/*734.19*/("""}"""),format.raw/*734.20*/(""");

                simpleLoad(btn, false)
            """),format.raw/*737.13*/("""}"""),format.raw/*737.14*/(""");
        """),format.raw/*738.9*/("""}"""),format.raw/*738.10*/(""");

        function simpleLoad(btn, state) """),format.raw/*740.41*/("""{"""),format.raw/*740.42*/("""
            """),format.raw/*741.13*/("""if (state) """),format.raw/*741.24*/("""{"""),format.raw/*741.25*/("""
                """),format.raw/*742.17*/("""btn.children().addClass('fa-spin');
                btn.contents().last().replaceWith(" Loading");
            """),format.raw/*744.13*/("""}"""),format.raw/*744.14*/(""" """),format.raw/*744.15*/("""else """),format.raw/*744.20*/("""{"""),format.raw/*744.21*/("""
                """),format.raw/*745.17*/("""setTimeout(function () """),format.raw/*745.40*/("""{"""),format.raw/*745.41*/("""
                    """),format.raw/*746.21*/("""btn.children().removeClass('fa-spin');
                    btn.contents().last().replaceWith(" Refresh");
                """),format.raw/*748.17*/("""}"""),format.raw/*748.18*/(""", 2000);
            """),format.raw/*749.13*/("""}"""),format.raw/*749.14*/("""
        """),format.raw/*750.9*/("""}"""),format.raw/*750.10*/("""
    """),format.raw/*751.5*/("""</script>
</body>
...
object faq extends faq_Scope0.faq
              /*
                  ...
                  SOURCE: /home/yachironi/git/myproject/app/views/template/faq.scala.html
                  HASH: c39539723b0d548dcbd31a4da14c93e77c467019
                  MATRIX: 832->0|44868->43967|44898->43968|44943->43984|45016->44028|45046->44029|45093->44047|45258->44183|45288->44184|45318->44186|45415->44254|45445->44255|45532->44313|45562->44314|45602->44326|45632->44327|45707->44373|45737->44374|45780->44388|45820->44399|45850->44400|45897->44418|46039->44531|46069->44532|46099->44533|46133->44538|46163->44539|46210->44557|46262->44580|46292->44581|46343->44603|46496->44727|46526->44728|46577->44750|46607->44751|46645->44761|46675->44762|46709->44768
                  LINES: 32->1|758->725|758->725|760->727|760->727|760->727|761->728|765->732|765->732|766->733|767->734|767->734|770->737|770->737|771->738|771->738|773->740|773->740|774->741|774->741|774->741|775->742|777->744|777->744|777->744|777->744|777->744|778->745|778->745|778->745|779->746|781->748|781->748|782->749|782->749|783->750|783->750|784->751
                  -- GENERATED --
              */
