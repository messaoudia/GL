                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        ...
                        <li>
                            <a href="grid_options.html">
                                <div>
                                    <i class="fa """),
format.raw("""fa-upload fa-fw"></i> Server Rebooted
                                    <span class="pull-right text-muted small">4 minutes ago</span>
                                </div>
                            </a>
                        </li>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div c"""),
format.raw("""lass="infont col-md-3 col-sm-4"><a href="#"><i class="fa fa-recycle"></i> fa-recycle</a></div>
                    ...
                    <div class="infont co"""),
format.raw("""l-md-3 col-sm-4"><a href="#"><i class="fa fa-minus"></i> fa-minus</a></div>
                    ...
                    <div class="infont col-md-3 col-sm-4"><a href="#"><i class="fa fa-ch"""),
format.raw("""ain-broken"></i> fa-chain-broken</a></div>
...
format.raw("""lass="fa fa-vimeo-square"></i> fa-vimeo-square</a></div>
...
object icons extends icons_Scope0.icons
              /*
                  ...
                  SOURCE: /home/yachironi/git/myproject/app/views/template/icons.scala.html
                  HASH: 06e772400d3d99c267205a2e83adab753d2ee9e2
                  MATRIX: 836->0
                  LINES: 32->1
                  -- GENERATED --
              */
