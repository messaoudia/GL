...
class diff extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {
...
<script>
    ...
    $(document).ready(function () """),format.raw/*485.35*/("""{"""),format.raw/*485.36*/("""
        ...
        """),format.raw/*487.9*/("""// Initial diff1
        $(".diff-wrapper").prettyTextDiff("""),format.raw/*488.43*/("""{"""),format.raw/*488.44*/("""
            """),format.raw/*489.13*/("""diffContainer: ".diff1"
        """),format.raw/*490.9*/("""}"""),format.raw/*490.10*/(""");


        // Initial diff2
        $(".diff-wrapper2").prettyTextDiff("""),format.raw/*494.44*/("""{"""),format.raw/*494.45*/("""
            """),format.raw/*495.13*/("""originalContent: $('#original').val(),
            changedContent: $('#changed').val(),
            diffContainer: ".diff2"
        """),format.raw/*498.9*/("""}"""),format.raw/*498.10*/(""");

        // Run diff on textarea change
        $(".diff-textarea").on('change keyup', function() """),format.raw/*501.59*/("""{"""),format.raw/*501.60*/("""
            """),format.raw/*502.13*/("""$(".diff-wrapper2").prettyTextDiff("""),format.raw/*502.48*/("""{"""),format.raw/*502.49*/("""
                """),format.raw/*503.17*/("""originalContent: $('#original').val(),
                changedContent: $('#changed').val(),
                diffContainer: ".diff2"
...
/**/
object diff extends diff_Scope0.diff
              /*
                  -- GENERATED --
                  DATE: Sat Feb 20 04:10:20 CET 2016
                  SOURCE: /home/yachironi/git/myproject/app/views/template/diff.scala.html
                  HASH: 99ac5129118162cb5dba17fb32910a5f9835a320
                  MATRIX: 834->0|27713->26830|27743->26831|27783->26843|27872->26903|27902->26904|27945->26918|28006->26951|28036->26952|28142->27029|28172->27030|28215->27044|28378->27179|28408->27180|28541->27284|28571->27285|28614->27299|28678->27334|28708->27335|28755->27353|28931->27500|28961->27501|29003->27515|29033->27516|29071->27526|29100->27527
                  LINES: 32->1|517->485|517->485|519->487|520->488|520->488|521->489|522->490|522->490|526->494|526->494|527->495|530->498|530->498|533->501|533->501|534->502|534->502|534->502|535->503|538->506|538->506|540->508|540->508|542->510|542->510
                  -- GENERATED --
              */
